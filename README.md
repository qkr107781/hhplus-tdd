...
#### 성능 비교(한명의 유저 대상) - 각 테스트별 10회씩 진행하여 평균 소요 시간 계산
> - ReentrantLock 테스트 결과: 평균 약 40초 소요
> - ConcurrentHashMap + ReentrantLock 테스트 결과: 평균 약 41초 소요
> - **한명의 유저 대상으로는 성능차이는 없는걸로 보임**

#### 성능 비교(5명의 유저 대상) - 각 테스트별 10회씩 진행하여 평균 소요 시간 계산
> - ReentrantLock 테스트 결과: 평균 약 200초 소요
> - ConcurrentHashMap + ReentrantLock 테스트 결과: 평균 약 42초 소요
> - **여러명의 유저 대상으로는 유저 수가 늘어나 수록 엄청난 차이가 벌어짐**
